...
# Bixby
SEC_FLOATING_FEATURE_BIXBY_CONFIG_CUSTOM_FIRMWARE=1
...
SEC_FLOATING_FEATURE_COMMON_CONFIG_SWLENS_DISTORTION_CORRECTION=a35x,IMX258
...
SEC_FLOATING_FEATURE_SYSTEM_CONFIG_SIOP_POLICY_FILENAME=siop_a35x_s5e8825
...
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A35 5G
